...
@section('pageContent')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{URL::route('parent.portal.profile')}}"><i class="fa fa-user-circle"></i> Profile</a></li>
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <div class="box box-info">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form class="form-horizontal" action="{{ route('parent.portal.change_password') }}" method="POST">
                        @csrf
                        <div class="box-body">
                            @if(session('success'))
                        ...
                        <div class="box-footer">
                            <a href="{{ route('parent.portal.profile') }}" class="btn btn-default">Cancel</a>
